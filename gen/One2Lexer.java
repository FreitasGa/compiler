...
public class One2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"Assign", "Plus", "Minus", "Asterisk", "Slash", "Percent", "Bang", "Equal", 
			"NotEqual", "Less", "Greater", "LessEqual", "GreaterEqual", "And", "Or", 
			"Comma", "Semicolon", "Colon", "LeftParen", "RightParen", "LeftBrace", 
			"RightBrace", "LeftBracket", "RightBracket", "If", "Else", "Function", 
			"Return", "While", "For", "Bool", "Int", "Float", "String", "Dot", "KeywordDeclaretion", 
			"Whitespace", "Newline", "BoolLiteral", "NumberLiteral", "StringLiteral", 
	...
	public One2Lexer(CharStream input) {
		super(input);
