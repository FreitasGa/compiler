...
variable_declaration : KeywordDeclaretion variable_name (Assign expression)?;

assignment : variable_name Assign expression;

function_declaration : Function variable_name LeftParen parameters? RightParen block;
